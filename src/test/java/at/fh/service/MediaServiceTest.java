...
class MediaServiceTest {
    ...
    // 1) findAll delegates
    @Test void findAll_delegatesToRepo() {
    ...
    @Test void findById_notFound_returnsEmpty_andDoesNotLoadGenres() {
    ...
    @Test void findById_found_attachesGenres() {
        UUID id = UUID.randomUUID();
    ...
    @Test void create_usesExistingGenre_doesNotSaveGenreAgain() {
    ...
    @Test void create_createsAndSavesGenreIfMissing() {
        UUID userId = UUID.randomUUID();
    ...
    @Test void create_multipleGenres_looksUpEach() {
        UUID userId = UUID.randomUUID();
    ...
    @Test void create_nullReleaseYear_defaultsToZero() {
        UUID userId = UUID.randomUUID();
    ...
    @Test void create_nullAgeRestriction_defaultsToZero() {
        UUID userId = UUID.randomUUID();
    ...
    @Test void create_setsCreatedByToUserId() {
        UUID userId = UUID.randomUUID();
    ...
    @Test void create_returnsFalseIfRepoSaveFails() {
        UUID userId = UUID.randomUUID();
        MediaInput in = new MediaInput("t","d",2010,12, List.of(), MediaType.MOVIE);
    ...
    @Test void update_notFound_returnsFalse() {
    ...
    @Test void update_keepsCreatedByAndCreatedAt() {
        UUID mediaId = UUID.randomUUID();
    ...
    @Test void search_delegatesToRepo() {
    ...
    @Test void update_nullAgeRestriction_defaultsToZero() {
        UUID mediaId = UUID.randomUUID();
    ...
    @Test void likeMedia_delegatesToRepo() {
    ...
    @Test void unlikeMedia_delegatesToRepo() {
        UUID mid = UUID.randomUUID();
        UUID uid = UUID.randomUUID();
    ...
    @Test void getDetails_notFound_returnsEmpty_andNoRatingCalls() {
        UUID mid = UUID.randomUUID();
        UUID uid = UUID.randomUUID();
    ...
    @Test void getDetails_found_populatesResponse() {
        UUID mid = UUID.randomUUID();
        UUID uid = UUID.randomUUID();
